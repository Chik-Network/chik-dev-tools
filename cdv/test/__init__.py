...
from chik.consensus.condition_tools import ConditionOpcode
...
from chik_rs import AugSchemeMPL, CoinRecord, G1Element, G2Element, PrivateKey, SpendBundle
...
class Wallet:
    ...
    # Give chik
    async def give_chik(self, target: Wallet, amt: uint64) -> CoinWrapper | None:
